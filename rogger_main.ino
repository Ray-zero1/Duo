...
void setup() {
  ...
  Serial.println("Pres\tTemp\tHum\tA_x\tA_y\tA_z\tAan_x\tAan_y\tAan_z\tg_x\tg_y\tg_z\tLatitude\tLongitude\tAlt");
  SD.begin(5);
  myFile = SD.open(f_name,FILE_APPEND);
  myFile.println("Pres\tTemp\tHum\tA_x\tA_y\tA_z\tAan_x\tAan_y\tAan_z\tg_x\tg_y\tg_z\tLatitude\tLongitude\tAlt");
}
